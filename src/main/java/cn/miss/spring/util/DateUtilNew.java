...
public class DateUtilNew {
    ...
    public static String dateOnlyStrToDateOnlyStr(String date, String fromPattern, String toPattern) {
        return LocalDate.parse(date, DateTimeFormatter.ofPattern(fromPattern)).format(DateTimeFormatter.ofPattern(toPattern));
    }
